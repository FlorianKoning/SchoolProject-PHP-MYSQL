...
<head>
    ...
    <title>Garage Ertan | Delete Auto</title>
...
<div class="title">
  <h1>Auto auto</h1>
    ...
    if ($verwijderen = 1) {
        ...
        $sql = $database->prepare("DELETE FROM autos WHERE klant_klantid = :klanten_klantid");
        $sql->execute(["klant_klantid" => $klanten_klantid]);
